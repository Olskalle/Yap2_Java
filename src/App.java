        ...
        while (!exitRequested) {
            ...
            switch (taskNum) {
                ...
                case 45:
                    ...
                    println("Результат добавления одного массива в другой: " + Tasks.add(
                        InputValidator.readIntArray(),
                        InputValidator.readIntArray(),
                ...
                case 47:
                    println("[Задание 4.7]");
                    println("Перевернутый массив: " + Tasks.reverseBack(InputValidator.readIntArray()));
                    break;
                case 49:
                    println("[Задание 4.9]");
                    println("Все вхождения введенного числа в массив: " + Tasks.findAll(
                        InputValidator.readIntArray(),
                        InputValidator.readInt(false)));
                    break;
                default:
